            ...
            <div class="info">
                    ...
                    ${
                      repo.primaryLanguage
                        ? `<div class="language">
                        <span class="indicator" style="background-color:${repo.primaryLanguage.color}"></span>
                        <p class="name">${repo.primaryLanguage.name}</p>
                    </div>`
                        : ""
                    }
                    ${
                      repo.stargazerCount !== 0
                        ...
                        <p class="name">${repo.stargazerCount}</p>
                    </div>`
                        : ""
                    }
                    ${
                    ...
                    ${
                      repo.licenseInfo
                        ...
                        <p class="name">${repo.licenseInfo.name} </p>
                    </div>`
                        : ""
                    }
